...
echo   3) Criar pastas data\ e data\documentos\
...
REM --- 3) Pastas data\ e data\documentos\ ---
echo.
if not exist "data\" mkdir "data"
if exist "data\documentos\" (
    echo [3/4] Pasta data\documentos\ ja existe.
) else (
    mkdir "data\documentos"
    echo [3/4] Pasta data\documentos\ criada.
)
